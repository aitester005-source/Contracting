              ...
              {showGallery && (
                ...
                >
                  <SectionHeader 
                    ...
                    subtitle="A showcase of our precision scaffolding work in Dubai, Abu Dhabi, and Sharjah"
                  />
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                      {[
                        { src: '/newlayout/images/portfolio/motor-city.jpg', title: 'Motor City Residential' },
                        { src: '/newlayout/images/portfolio/sustainable-city.jpg', title: 'Sustainable City Villas' },
                        { src: '/newlayout/images/portfolio/sharjah-government.jpg', title: 'Sharjah Government Project' },
                        { src: '/newlayout/images/portfolio/portfolio-page8-img3.png', title: 'External Facade Support' },
                        { src: '/newlayout/images/portfolio/portfolio-page6-img4.png', title: 'Heavy Duty Industrial' },
                        { src: '/newlayout/images/portfolio/portfolio-page4-img7.png', title: 'Complex Tower Access' },
                      ].map((img, idx) => (
                        <motion.div 
                          key={idx} 
                        ...
                        >
                          ...
                          />
                          <div className="absolute inset-0 bg-gradient-to-t from-primary-dark/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                ...
                <div className="py-8 md:py-12">
                  <div className="container-custom px-4 mb-4 text-center">
                    <SectionHeader 
                      ...
                      subtitle="Connect with our professional network and industry experts"
                    />
                  </div>
                  <div className="container-custom px-4">
                    <div className="max-w-4xl mx-auto bg-[#f3f6f8] rounded-3xl overflow-hidden shadow-2xl border border-gray-200">
                      <div className="bg-[#0077b5] p-6 md:p-8 text-white flex flex-col md:flex-row items-center gap-6">
                        <div className="w-20 h-20 bg-white rounded-xl flex items-center justify-center p-2 shadow-inner">
                           <img src="/newlayout/images/logo.jpeg" alt="Hedefy" className="object-contain" />
                        </div>
              ...
              >
                <div className="py-0">
                  <div className="container-custom px-4 mb-0 text-center">
                    <SectionHeader 
                      title="Live Facebook Feed" 
                      subtitle="Follow us for daily updates and behind-the-scenes content"
                    />
                  </div>
          ...
          <AnimatePresence>
            {selectedImage && (
              <motion.div 
                ...
                className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-primary-dark/95 backdrop-blur-sm cursor-zoom-out"
              >
                <motion.div 
                  ...
                  className="relative max-w-5xl w-full bg-white rounded-3xl overflow-hidden shadow-2xl cursor-default"
                >
                  <button 
                    onClick={() => setSelectedImage(null)}
                  ...
                  <div className="p-8 bg-white text-center">
                    <h3 className="text-2xl font-bold text-primary-dark">{selectedImage.title}</h3>
                    <p className="text-gray-600 mt-2">Hedefy Scaffolding Contracting - Precision & Safety</p>
                  </div>
                </motion.div>
              </motion.div>
            )}
